      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            localStorage.setItem("jmeter_last_payment", JSON.stringify({
      ...
      <div style={{
        ...
        <main className="payment-main-content">
          ...
          <div style={{
            ...
            }} viewBox="0 0 320 160" fill="none" xmlns="http://www.w3.org/2000/svg">
              <ellipse cx="160" cy="80" rx="160" ry="80" fill="#FFE0B2" fillOpacity="0.7">
                <animate attributeName="rx" values="160;170;160" dur="6s" repeatCount="indefinite" />
                <animate attributeName="ry" values="80;85;80" dur="6s" repeatCount="indefinite" />
              </ellipse>
            </svg>
              ...
              <div style={{ marginBottom: '32px' }}>
                ...
                <div style={{
                  ...
                  <input
                    ...
                    max="12"
                    value={months}
                    onChange={(e) => {let value = parseInt(e.target.value);
